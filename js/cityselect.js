...
Vcity.CitySelector.prototype = {
    ...
    createWarp:function(){
        ...
        div.style.left = inputPos.left -100+ 'px';
    ...
    KeyboardEvent:function(event,keycode){
        ...
        switch(keycode){
            ...
            case 13: // enter键
                ...
                cur_city_code(this.input.value)
                Vcity._m.addClass('hide',this.ul);
                Vcity._m.addClass('hide',this.ul);
                /* IE6 */
